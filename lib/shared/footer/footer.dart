...
class _FooterState extends State<Footer> {
  ...
  void _updateTime() {
    ...
    final gmt5Time = utcNow.add(const Duration(hours: 5,minutes: 30));
    final formatter = DateFormat('h:mm a');
    setState(() {
      _coimbatoreTime = formatter.format(gmt5Time);
    });
  }
  ...
  Widget _buildDesktopLayout(BuildContext context) => Row(
    ...
    children: [
      ...
      Text(
        'rakshan864@gmail.com',
        style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: AppColors.textPrimary.withValues(alpha: .7)),
      ),
      Text(
        'Coimbatore, $_coimbatoreTime',
        style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: AppColors.textPrimary.withValues(alpha: .7)),
      ),

      const Row(
        children: [
          _SocialIcon(icon: Icons.code, tooltip: 'GitHub', url: 'https://github.com/Samrakshan-Prog'),
          SizedBox(width: 16),
          _SocialIcon(icon: Icons.work, tooltip: 'LinkedIn', url: 'https://www.linkedin.com/in/srisamrakshan-parthiban-64847535b'),
          SizedBox(width: 16),
          _SocialIcon(
            icon: LucideIcons.instagram,
            tooltip: 'Instagram',
            url: 'https://www.instagram.com/_sam_jf/',
          ),
        ],
      ),
    ],
