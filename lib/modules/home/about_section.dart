    ...
    children: [
      ...
      ScrollReveal(
        ...
        child: Padding(
          ...
          child: AutoSizeText(
            "I'm Mukhil, a MERN Stack Dev skilled in React, Node.js & MongoDB.I craft cross-platform apps using Electron. Clean code, real impact.",
            style: Theme.of(
              context,
      ...
      Row(
        ...
        children: [
          ...
          ScrollReveal(
            ...
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, '2+', 'Projects\nCompleted'),
          ),
          ScrollReveal(
            delay: const Duration(milliseconds: 1200),
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, 'Thousands', 'of Codes\nWritten'),
          ),
        ],
      ),
